...
sol = EightPuzzle((1, 0, 2, 4, 5, 3, 7, 8, 6), (1, 2, 3, 4, 5, 6, 7, 8, 0))
print(sol.check_solvability((1, 0, 2, 4, 5, 3, 7, 8, 6)))
print(sol.path_cost(0, 3, 1, 2))
print(sol.result((1, 0, 2, 4, 5, 3, 7, 8, 6), 'UP'))
# ______________________________________________________________________________
