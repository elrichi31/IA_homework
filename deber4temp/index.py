...
def main(hof_size):
    # Inicialización de la población, fitnesses, etc.
    toolbox = train()
    ...
    createGraf1(population)
    createGraf2(hof)
    createGraf3(logbook)

    return hof, logbook

hof5, logbook5 = main(5)
print("Evaluación con HallOfFame de tamaño 5 completada.")

hof30, logbook30 = main(30)
print("Evaluación con HallOfFame de tamaño 30 completada.")